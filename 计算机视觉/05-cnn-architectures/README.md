...
| 章节 | 内容 | 难度 |
|------|------|------|
| **[01-经典架构](README.md)** | LeNet, AlexNet, VGG, ResNet, DenseNet | ⭐-⭐⭐⭐ |
...
# 依赖: copy, time, torch, torchvision
# 安装: pip install copy time torch torchvision
import torch
import torch.nn as nn
