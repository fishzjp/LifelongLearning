...
> 跨里程碑的补充题库：各里程碑的 [practice.md](M0/practice.md) 是过关必做，这里的题是**加练**——按"基础 / 编程 / 项目 / 挑战"四档分类，学有余力或想专项突破时来选题。

**用法**：不必顺序刷；建议学完对应里程碑后，回来做同档位的 2-3 题巩固。
