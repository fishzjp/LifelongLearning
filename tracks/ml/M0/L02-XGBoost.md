...
> 同样是梯度提升，XGBoost 为什么能快十倍还更准？答案藏在四个工程创新里：二阶导数优化、正则化剪枝、列抽样、并行特征分裂。学完你能调参时知道每个参数在动什么。

**前置知识**：[第一部分](L01-%E6%A2%AF%E5%BA%A6%E6%8F%90%E5%8D%87.md)。
**预计投入**：60-90 分钟。

**上一篇**: [第一部分](L01-%E6%A2%AF%E5%BA%A6%E6%8F%90%E5%8D%87.md) | **下一篇**: [第三部分：LightGBM 详解](L03-LightGBM.md)
...
![特征重要性可视化示意图](../../cv/assets/Gemini_Generated_Image_4tcft24tcft24tcf.png)