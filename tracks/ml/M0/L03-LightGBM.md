...
> 千万级样本一跑一整天？LightGBM 用 Leaf-wise 生长、直方图算法、并行学习三招把训练提速数倍、内存降到两三成。学完你能说清它和 XGBoost 的取舍，并为大数据场景选对工具。

**前置知识**：[第二部分：XGBoost 详解](L02-XGBoost.md)。
**预计投入**：60-90 分钟。

**上一篇**: [第二部分](L02-XGBoost.md) | **下一篇**: [第四部分：实践指南](L04-%E5%AE%9E%E8%B7%B5%E6%8C%87%E5%8D%97.md)
...
![Level-wise vs Leaf-wise 树生长对比](../../cv/assets/Gemini_Generated_Image_e5hpq6e5hpq6e5hp.png)
